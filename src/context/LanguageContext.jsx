...
const translations = {
  ...
  TW: {
    ...
    terms7Title: '7. 資料與隱私',
    terms7Text: '您使用本 App 也受我們隱私權政策的約束。目前所有資料都儲存在您的裝置本機。當實施雲端同步功能時，可能會適用額外條款。您有責任備份您的資料。我們對任何資料遺失不承擔責任。',
    terms8Title: '8. 免責聲明',
    terms8Text: '本 APP 基於「現狀」和「現有」提供，不提供任何明示或暗示的保證，包括但不限於適銷性、特定目的適用性和非侵權的暗示保證。\n\n我們不保證：\n• 本 App 將不間斷、安全或無錯誤。\n• 缺陷將被修正。\n• 本 App 不含病毒或其他有害組件。\n• AI 生成的內容將準確或適合您的需求。',
    terms9Title: '9. 責任限制',
    terms9Text: '在法律允許的最大範圍內，A DAY、其高級職員、董事、員工或代理人在任何情況下均不對任何間接、附帶、特殊、後果性或懲罰性損害賠償負責，包括但不限於利潤、資料、使用或商譽的損失，這些損失源於或與您使用本 APP 有關。\n\n我們對您因使用本 App 而產生的所有索賠的總責任，不得超過您在索賠前十二（12）個月內支付給我們的金額。',
